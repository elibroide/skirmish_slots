...
export interface SlotState {
  unit: UnitState | null; // Snapshot of the unit
...
export interface GameState {
  ...
  // isDone: [boolean, boolean];           // Removed - Moved to PlayerState
  // hasActedThisTurn: [boolean, boolean]; // Removed - Moved to PlayerState
  // hasPlayedCardThisTurn: [boolean, boolean]; // Removed - Moved to PlayerState
...
export interface UnitCard extends Card {
  ...
  readonly hasDominant: boolean;           // True if unit has Dominant trait
  readonly dominantTriggered: boolean;     // True if Dominant has already fired
  canActivate(): boolean;
...
// Update SlotState to use UnitState
// export interface SlotState {
//   unit: UnitState | null; 
//   modifier: number; 
// }
// Wait, I need to update SlotState definition earlier in the file.
