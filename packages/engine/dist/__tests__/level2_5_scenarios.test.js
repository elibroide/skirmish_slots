...
describe('Level 2.5: Advanced Mechanics & Scenarios', () => {
    ...
    it('should intercept damage with ShieldTrait', async () => {
        ...
        while (ticks < 50) {
            ...
            if (engine.state.currentSkirmish > 1)
                break; // Skirmish ended
            ticks++;
        }
